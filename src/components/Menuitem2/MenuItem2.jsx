        ...
        <div className="app__menuitem">
            <div className="app__menuitem-head">
                <div className="app__menuitem-name">
                    <p className="p__cormorant text-sm md:text-2xl" style={{ color: '#DCCA87' }}>{title}</p>
                </div>
                <div className="app__menuitem-dash" />
                <div className="app__menuitem-price1">
                    {title.includes("Coca") ? <p className="p__cormorant text-xs  md:text-2xl ">{price}</p> : <p className="p__cormorant text-sm md:text-2xl ">{price}</p>}
                </div>
            </div>
